...
// El reproductor de RTTTL viene del ejemplo:
...
{
  public:
    piezoSpeaker(int pinNr = -1) : nodeComponent()
    {
		m_pin = pinNr;
    }
    ...
    void playTone(int freq =50,int toneDuration=100)
    {
        if(isValid())
        {
            ...
            {
                tone(m_pin,freq,toneDuration );
                delay(toneDuration);
                noTone(m_pin);
                delay(toneDuration/4);
  ...
  const int notes[50] = { 0, NOTE_C4, NOTE_CS4, NOTE_D4, NOTE_DS4, NOTE_E4, NOTE_F4, NOTE_FS4, NOTE_G4, NOTE_GS4, NOTE_A4, NOTE_AS4, NOTE_B4,
...
{
public:
    static constexpr char* pacman = "PacMan:d=16,o=6,b=140:b5,b,f#,d#,8b,8d#,c,c7,g,f,8c7,8e,b5,b,f#,d#,8b,8d#,32d#,32e,f,32f,32f#,g,32g,32g#,a,8b";
    static constexpr char* gameover = "gameover:d=4,o=4,b=200:8c5,4p,8g4,4p,4e4,6a4,6b4,6a4,6g#4,6a#4,6g#4,4g4,4f4,2g4";
