...
void readSDM630()
{
  ...
  publish(topic+"volts"        ,String(sdm.readVal(SDM630_VOLTAGE_AVERAGE)));
  publish(topic+"amps"         ,String(sdm.readVal(SDM630_CURRENTSUM)));
  publish(topic+"power"        ,String(sdm.readVal(SDM630_POWERTOTAL)));
  publish(topic+"powerFactor"  ,String(sdm.readVal(SDM630_POWER_FACTOR_TOTAL)));
  ...
  json[F("volts")]      = sdm.readVal(SDM630_VOLTAGE_AVERAGE);
  json[F("volts1")]     = sdm.readVal(SDM630_VOLTAGE1);
  json[F("volts2")]     = sdm.readVal(SDM630_VOLTAGE2);
  json[F("volts3")]     = sdm.readVal(SDM630_VOLTAGE3);

  json[F("amps")]       = sdm.readVal(SDM630_CURRENTSUM);
  json[F("amps1")]      = sdm.readVal(SDM630_CURRENT1);
  json[F("amps2")]      = sdm.readVal(SDM630_CURRENT2);
  json[F("amps3")]      = sdm.readVal(SDM630_CURRENT3);
  
  json[F("power")]      = sdm.readVal(SDM630_POWERTOTAL);
  json[F("power1")]     = sdm.readVal(SDM630_POWER1);
  json[F("power2")]     = sdm.readVal(SDM630_POWER2);
  json[F("power3")]     = sdm.readVal(SDM630_POWER3);
  
  json[F("activePower")]    = sdm.readVal(SDM630_VOLT_AMPS_TOTAL);
  json[F("activePower1")]   = sdm.readVal(SDM630_VOLT_AMPS1);
  json[F("activePower2")]   = sdm.readVal(SDM630_VOLT_AMPS2);
  json[F("activePower3")]   = sdm.readVal(SDM630_VOLT_AMPS3);
  
  json[F("reactivePower")]  = sdm.readVal(SDM630_VOLT_AMPS_REACTIVE_TOTAL);
  json[F("reactivePower1")] = sdm.readVal(SDM630_VOLT_AMPS1);
  json[F("reactivePower2")] = sdm.readVal(SDM630_VOLT_AMPS2);
  json[F("reactivePower3")] = sdm.readVal(SDM630_VOLT_AMPS3);
 
  json[F("powerFactor")]    = sdm.readVal(SDM630_POWER_FACTOR_TOTAL);
  json[F("powerFactor1")]   = sdm.readVal(SDM630_POWER_FACTOR1);
  json[F("powerFactor2")]   = sdm.readVal(SDM630_POWER_FACTOR2);
  json[F("powerFactor3")]   = sdm.readVal(SDM630_POWER_FACTOR3);

  json[F("phaseAngle")]     = sdm.readVal(SDM630_PHASE_ANGLE_TOTAL);
  json[F("phaseAngle1")]    = sdm.readVal(SDM630_PHASE_ANGLE1);
  json[F("phaseAngle2")]    = sdm.readVal(SDM630_PHASE_ANGLE2);
  json[F("phaseAngle3")]    = sdm.readVal(SDM630_PHASE_ANGLE3);
  
  json[F("frecuency")]      = sdm.readVal(SDM630_FREQUENCY);

  json[F("importActive")]   = sdm.readVal(SDM630_IMPORT_ACTIVE_ENERGY);
  json[F("exportActive")]   = sdm.readVal(SDM630_EXPORT_ACTIVE_ENERGY);
  json[F("importReactive")] = sdm.readVal(SDM630_IMPORT_REACTIVE_ENERGY);
  json[F("exportReactive")] = sdm.readVal(SDM630_EXPORT_REACTIVE_ENERGY);

  json[F("totalDemand")]    = sdm.readVal(SDM630_TOTAL_SYSTEM_POWER_DEMAND);
  json[F("maxDemand")]      = sdm.readVal(SDM630_MAXIMUM_TOTAL_SYSTEM_POWER);
